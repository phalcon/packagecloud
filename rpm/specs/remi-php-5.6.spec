...
%global src_dir build/php5/safe
%if %{__isa_bits} == 32
%global src_dir build/php5/32bits
%endif
%if %{__isa_bits} == 64
%global src_dir build/php5/64bits
%endif
...
BuildRequires: php56u-pecl-jsonc-devel%{?_isa}
BuildRequires: php56u-devel%{?_isa}
%if %{with_libpcre}
...
Requires: php56u-pdo%{?_isa}
Requires: php56u-common%{?_isa}
